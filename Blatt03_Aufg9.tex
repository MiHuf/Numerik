...
Wir bestimmen mit Hilfe der Formeln \eqref{col1}, \eqref{col2} und \eqref{col3}
\begin{align*}
L=
\begin{split}
\begin{pmatrix}
...
\end{split}
\end{align*}
Alle Einträge für die $i < k$ gilt wurden bereits auf die 0 gesetzt.\\

$l_{11}: i=k$ es gilt also Formel \eqref{col2}\\
\begin{align*}
...
$l_{21}: i > k$ es gilt also Formel \eqref{col3}\\
\begin{align*}
...
$l_{31}: i > k$ es gilt also Formel \eqref{col3}\\
\begin{align*}
...
$l_{22}: i=k$ es gilt also Formel \eqref{col2}\\
\begin{align*}
...
$l_{32}: i > k$ es gilt also Formel \eqref{col3}\\
\begin{align*}
...
$l_{33}: i=k$ es gilt also Formel \eqref{col2}\\
\begin{align*}
...
Aus $L$ lässt sich also auch $L^*$ ablesen mit:
\begin{align*}
L^*=
\begin{split}
\begin{pmatrix}
