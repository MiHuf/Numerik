...
$|x_i| \ge |x_j| \; \forall \; j=\{1,...,n\}$ gegeben ist. Dann wird:
\begin{align}
  \nonumber
...
\begin{align}
  | a_{ii} \cdot x_i | &=
    \left | \sum_{\substack{j = 1 \\j \neq i}}^n a_{ij} \cdot x_j \right | \le
    \sum_{\substack{j = 1 \\j \neq i}}^n | a_{ij} \cdot x_j |
\end{align}
 Wir können wir nun abschätzen, da $|x_i|$ die betragsmäßig
...
also falsch. Da aber $|x_i| \ge |x_j|\;\forall j=\{1,...,n\}$ gilt, folgt auch
$x_j=0\;\forall j=\{1,...,n\}$ Der Kern von A ist somit trivial und dann ist A invertierbar.
