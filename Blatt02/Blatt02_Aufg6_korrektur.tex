...
\textcolor{red}{zu zeigen ist: $\condb(A) = 1 \Leftrightarrow A=\lambda U$ mit $U^*U=I,\lamda \in  \KK$}
Noch zu zeigen: Sei $U$ unitäre Matrix. $A = U^k \; \Leftrightarrow \;  \condb(A) = 1$

"`$\Rightarrow$"': Unitäre Matrizen sind definiert durch $U^* \cdot U = I$. Ihre
Eigenwerte haben stets den Betrag 1, Beweis: Sei $\lambda$ Eigenwert von $U$ zum Eigenvektor $x$,
dann gilt:
\begin{align*}
...
\end{align*}
Die Matrix $A = U^k$ ist ebenfalls unitär, denn
...
da $A$ zudem unitär ist, haben alle Eigenwerte den Wert 1, d.h. $\lambda_{\max} = 1$.
Die inverse Matrix $(A^* \cdot A)^{-1}$ ist - da $A$ unitär ist, gleich der Matrix
...
Die jeweils größten Eigenwerte dieser Matrizen findet man in Gleichung (\ref{eq17}), d.h.
$\lambda_1 \cdot \frac{1}{\lambda_n} = 1 \; \Rightarrow \; \lambda_1 = \lambda_n = 1$.
Daraus folgt $(A^* \cdot A)\; x = 1 \cdot x \; \Rightarrow \; (A^* \cdot A) = I$ und
somit ist $A$ unitär und wegen Gleichung (\ref{eq18}) gilt das auch für $U := \sqrt[k]{A}$.
\begin{flushright}Q.e.d.\end{flushright}
